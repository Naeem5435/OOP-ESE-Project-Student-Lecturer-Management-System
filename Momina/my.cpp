...
int main()
{
	...
	string file2 = "Lecturers.txt";
	string file3 =  "Appointments.txt";
	...
	while(menuLoop!=5)
	{
		...
		else if(menuLoop==2)
		{
			...
			else if(menu==2)
			{
				...
				cout<<endl;
				cout<<"Lec Id       Name      Department       Email          Contact no.    Title"<<endl;
		...
		else if(menuLoop==3)
		{
			...
			cout<<"**--------------------------  ***Welcome*** ----------------------**"<<endl;
			cout<<endl;
			cout<<"Student Id  Lecturer Id  Appointment Date       Time"<<endl;
		...
		else if(menuLoop==4)
		{
			...
			writeToFile.open("Lecturers.txt");
			for(i=0;i<y;i++)
			{
				writeToFile<<" "<<_L[i].getNumber()<<"     "<<_L[i].getName()<<" "<<_L[i].getSurname()<<"         "<<_L[i].getDepartment()<<"       "<<_L[i].getEmail()<<"       "<<_L[i].getPhone()<<"       "<<_L[i].getChair()<<endl;
			}
			writeToFile.close();
			//updated appointment file is writing
			writeToFile.open("Appointments.txt");
			for(i=0;i<z;i++)
			{
